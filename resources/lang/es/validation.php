...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'end_date'              => 'fecha fin',
        'surcharge'             => 'recargo',
        'deadline_enrollment_1'     => 'fecha limite 1',
        'deadline_enrollment_2'     => 'fecha limite 2',
        'inscription_paylimit_days' => 'plazo en dias para pago',
        'schedule'              => 'horario',
        'surname'               => 'apellido',
        ...
        'schoolday_id'          => 'jornada',
        'ethnic_group_id'       => 'etnia',
        'city_id'               => 'ciudad',
        'department_id'         => 'departamento',
        'ex_student'            => 'ex-alumno',
        'tutor_document_type_id'=> 'tipo documento',
        'document_type_id'      => 'tipo documento',
        'weight'                => 'peso',
        'intensity'             => 'intensidad',
        'approve'               => 'aprobación',
        'letter'                => 'letra',
        'note_setup_id'         => 'sistema de calificación',
    ],
];
