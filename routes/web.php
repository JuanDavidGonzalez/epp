...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['role:coordinator'])->prefix('usuarios')->name('user.')->group(function () {
        ...
        Route::put('{user}/editar', 'UserController@update')->name('update');
    });
    ...
    Route::get('actividades/{activity}/list', 'ActivityController@list')->name('activity.list');//API
    Route::get('actividades/{activity}/risks', 'ActivityController@risks')->name('activity.risks');//API

    Route::get('usuarios/{user}/listProcesses', 'UserController@listProcesses')->name('user.listProcesses');//API
    Route::get('procesos/{process}/list', 'ActivityController@listActivities')->name('activity.listActivities');//API
    ...
    Route::prefix('solicitudes')->name('request.')->group(function () {
        ...
        Route::put('{request}/editar', 'HomeController@update')->name('update');

        Route::get('exportar', 'HomeController@export')->name('export');
    });
});
